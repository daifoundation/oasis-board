...
- **baseAmt** - amount of base tokens, integer representation of fixed-point number with base token precision. E.q. `baseAmt` = 1 with basePrecision = 2 represents 0.01 tokens.
